...
import { LayoutDashboard, Activity, Users, Shield, LogOut, ChevronLeft, Code2, Settings } from 'lucide-react'
...
const navItems = [
  ...
  ...(FEATURES.ADMIN_PANEL ? [{ to: '/admin',     label: 'Admin',     icon: Users, adminOnly: true }] : []),
  ...(FEATURES.ADMIN_SETTINGS ? [{ to: '/admin/settings',     label: 'Settings',     icon: Settings, adminOnly: true }] : []),
]
